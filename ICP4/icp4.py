...
instance = tk.texts_to_sequences(instance)
...
instance = pad_sequences(flat_list, padding='post', maxlen=10000)
result = base_model.predict(instance)
print(result)
